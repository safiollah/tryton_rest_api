...
(function() {
    ...
    Sao.field.Float = Sao.class_(Sao.field.Field, {
        ...
        digits: function(record, factor=1) {
            ...
            // Add check: Ensure digits is a valid array before proceeding
            if (!digits || !Array.isArray(digits) || digits.length < 2) {
                Sao.Logger.warn("Invalid digits configuration for field %s", this.name);
                return; // Return undefined if digits are invalid
            }
